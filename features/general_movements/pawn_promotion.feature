Feature: Pawn gets promotted
    Scenario Outline: Pawn reaches the last enemy row
        ...
        And I should get prompted with an option to choose which piece to promote the <piece_color> 'Pawn' to
...
#     And I get prompted with an option to choose which piece to promote the pawn to

#     When I choose to promote the pawn to a <promotion_piece>

#     Then the <piece_color> 'Pawn' on square <row_to_move> <column> should now be a <piece_color> <promotion_piece>